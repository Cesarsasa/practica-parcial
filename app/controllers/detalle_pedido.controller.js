...
const Detpedido = db.detalle_pedidos;
...
exports.findAll = (req, res) => {
    ...
    var condition = id_pedido ? { id_pedido: { [Op.iLike]: `%${id_pedido}%` } } : null;

   Detpedido.findAll({ where: condition })
        .then(data => {
            res.send(data);
        })
        .catch(err => {
...
exports.findAllStatus = (req, res) => {
    Detpedido.findAll({ where: { status: true } })
        .then(data => {
            res.send(data);
        })
        .catch(err => {
